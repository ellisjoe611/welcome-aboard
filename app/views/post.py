...
class PostMasterView(FlaskView):
    ...
    @login_required
    def add_post(self, title: str, content: str, category_ids: Optional[List[ObjectId]]):
...
class PostDetailView(FlaskView):
    ...
    @login_required
    def update_post(self, post_id: ObjectId, title: str, content: str, category_ids: Optional[List[ObjectId]]):
        # 포스트 검색
